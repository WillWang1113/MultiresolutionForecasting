...
# # ? Test out of distribution is shit
# # OFFLINE TRAINING
# def train_and_test(
#     system,
#     dltrain,
...
#         logger.info(
#             "[epoch={}] epoch_duration={:.2f} | train_loss={:.5f}\t| val_loss={:.5f}\t| val_mse={:.5f}".format(
...
#     test_preds = system.predict(dltest)
#     val_preds = system.predict(dlval)
#     train_preds = system.predict(dltrain)
...
#     test_loss, test_mse, preds = system.test_step(dltest)
#     test_mse = test_mse.item()
#     test_rmse = np.sqrt(test_mse)
#     return (
#         test_rmse,
